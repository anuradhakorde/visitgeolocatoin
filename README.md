...
To build the final jar and optimize the VisitGeoLocation application for production, run:
...
Then navigate to [http://localhost:7979](http://localhost:7979) in your browser.
