...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '1e96ea4d-368f-4baf-8824-d7a4321aeefd' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('f6aa7de8-0bda-4336-8ead-bffe8bdc4002');
      cy.get(`[data-cy="name"]`).should('have.value', 'f6aa7de8-0bda-4336-8ead-bffe8bdc4002');
